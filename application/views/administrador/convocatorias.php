                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 text-right">
                                                <a class='btn btn-danger' href='<?php echo base_url('administrador/convocatorias/requisitos/' . $conv_abiertas[$a]->id_convocatoria) ?>'>
                                                    <span class="glyphicon glyphicon-list-alt" aria-hidden="true"> </span>  Gestionar Requisitos
                                                </a>
                                            </div>                                            
                                        </div>
                                        <br>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div id="collapse<?php echo $conv_cerradas[$c]->id_convocatoria ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading<?php echo $conv_cerradas[$c]->id_convocatoria ?>">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 text-right">
                                                <a class='btn btn-danger' href='<?php echo base_url('administrador/convocatorias/requisitos/' . $conv_cerradas[$c]->id_convocatoria) ?>'>
                                                    <span class="glyphicon glyphicon-list-alt" aria-hidden="true"> </span>  Gestionar Requisitos
                                                </a>
                                                <a class='btn btn-info' href='<?php echo base_url('administrador/convocatorias/invitar/' . $conv_cerradas[$c]->id_convocatoria) ?>'>
