                ...
                <form class="form-horizontal" enctype="multipart/form-data" role="form" id="formCrearUsuario" action="<?php echo base_url('ciudadano/principal/actualizarUsuario') ?>" name="formCrearUsuario" method="post">
                    ...
                    <div class="form-group has-feedback">
                        <div class="col-sm-6 text-left">
							...
							<input type="text" value="<?php echo $datosUsuario[0]->telefono?>" class="validate[required] form-control" id="inputTelefono" name="inputTelefono" placeholder="Tel&eacute;fono">
                            <span class="fa fa-check form-control-feedback"></span>
                        </div>
                        <div class="col-sm-6 text-left">
                            <label for="inputClave" class="control-label">Celular:</label>
							<input type="text" value="<?php echo $datosUsuario[0]->celular?>" class="validate[required, ] form-control" id="inputCelular" name="inputCelular" placeholder="Celular">
                            <span class="fa fa-check form-control-feedback"></span>
                        </div>
                    </div>
                    <div class="form-group has-feedback">
                        <div class="col-sm-6 text-left">
							...
							<div class="input-group input-append date" id="datePicker">
								<input type="text" readonly value="<?php echo $datosUsuario[0]->fecha_naci?>" class="form-control validate[required]" name="fechaNaci" id="fechaNaci" />
						...
						<div class="col-sm-6 text-left">
                            <label class="control-label">Nacionalidad:</label>
								...
								for($p=0;$p<count($paises);$p++)
								{
									...
									{
										echo "<option value='".$paises[$p]->codi_pais."' selected>".$paises[$p]->desc_pais."</option>";
									}else{
										echo "<option value='".$paises[$p]->codi_pais."'>".$paises[$p]->desc_pais."</option>";	
									}									
								}
								?>
								</select>
