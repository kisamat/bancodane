...
<div class="row">
    <div class="col-md-2 col-md-offset-5">
        <center>
            <a href="<?php echo base_url('coordinador/expertos/crearExperto') ?>">
                <img src="<?php echo base_url('assets/img/miembros.png') ?>">
                <br>
                <?php echo $this->lang->line('Crear Experto'); ?>
            </a>
        </center>
    </div>
</div>
...
foreach ($expertos as $row) {
    ?>
        <tr>
			...
			<td>
                <center>
                    <a href="<?php echo base_url('coordinador/expertos/borrarExperto/' . $row->id_experto) ?>">
