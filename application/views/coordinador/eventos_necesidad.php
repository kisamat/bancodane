...
<div class="row">
    <div class="col-md-2 col-md-offset-5">
        <center>
            <a href="<?php echo base_url('coordinador/eventos_necesidad/crearEvento') ?>">
...
<div id="tabsEvento">
    <ul>
        <li><a href="#tabsGrupo-1"><?php echo $this->lang->line('Necesidad de Capacitación'); ?></a></li>
    </ul>
    <div id="tabsEvento-1">
...
foreach ($eventos_usuario as $row) {
    ?>
        <tr>
            ...
            <td>
                <center>
                    <a href="#" onclick="borrarEventoCoorNecesidad(<?php echo $row->id_evento;?>)">
...
<div id="borrarEveNeceCoor-confirm" title="<?php echo $this->lang->line('Borrar Evento Necesidad'); ?>">
